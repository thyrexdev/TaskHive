...
const apiFetch = async (endpoint, options)=>{
    ...
    const res = await fetch("".concat(baseUrl).concat(endpoint), {
        credentials: "include",
        ...options,
        headers: {
    ...
    if (!res.ok) {
        throw new Error("API request failed with status ".concat(res.status));
    }
    return res;
};
...
const AuthProvider = (param)=>{
    ...
    const login = async (email, password)=>{
        try {
            setLoading(true);
            setError(null);
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])("/auth/login", {
                method: "POST",
                credentials: "include",
                body: JSON.stringify({
                    email,
            ...
            const me = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])("/auth/me", {
                credentials: "include"
            }, {
    ...
    const logout = async ()=>{
        try {
            setLoading(true);
            setError(null);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])("/auth/logout", {
                method: "POST",
                credentials: "include"
            });
            setUser(null);
...
//# sourceMappingURL=_4431a110._.js.map