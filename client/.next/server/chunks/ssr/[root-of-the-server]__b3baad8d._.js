...
const AuthProvider = ({ children })=>{
    ...
    const login = async (email, password)=>{
        try {
            ...
            const me = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])("/auth/me", {
                credentials: "include"
            }, {
    ...
    const logout = async ()=>{
        try {
            setLoading(true);
            setError(null);
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])("/auth/logout", {
                method: "POST",
                credentials: "include"
            });
            setUser(null);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b3baad8d._.js.map